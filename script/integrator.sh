...
COMMAND="java -server -Xms512m -Xmx512m -classpath $HADOOP_HOME/core-site.xml:$HADOOP_HOME/hdfs-site.xml:$HADOOP_HOME/mapred-site.xml:$HADOOP_HOME/yarn-site.xml -Dspring.profiles.active=prod -jar $APP_BASE/bin/integrator-0.0.1-*.war"
